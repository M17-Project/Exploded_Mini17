...
## Flashing
To enter the DFU mode, keep BTN2 pressed while powering the board up. A sample firmware (CubeIDE project) is available through a [separate repository](https://github.com/M17-Project/Exploded_Mini17-fw-test). Another example is in the `MCU` folder.
